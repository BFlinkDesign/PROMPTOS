...
- Three taxonomy labels were composed from raw part-code spelling and all three were
  wrong versus the captured dropdown HTML. Verbatim extraction replaced 100% of
  guessed labels.
