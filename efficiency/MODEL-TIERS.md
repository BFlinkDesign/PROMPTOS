...
[model-router](../prompts/model-router.md); task-shape routing table:
[agent-os §1](../playbooks/agent-os.md).
...
- **Proof this works:** in production, a hand-caught estimating miss was
  promoted the same day into extraction anchors + a context sweep + regression
  tests with negative controls. The system got permanently harder to fool at
