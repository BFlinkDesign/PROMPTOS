...
| Do | Don't |
| --- | --- |
| Tool repos on local disk (a local canonical clone) | Git repos on SMB/network shares (slow, lock-prone) |
...
| Hide AI dot-folders from shared-drive users (`attrib +h`) | `.claude/` visible on shared drives |
