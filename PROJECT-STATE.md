...
1. the 16-prompt quality contract and adversarial-case coverage,
...
- prompt quality: 16 prompts checked, minimum 85/100, 9 adversarial cases covered
- catalog evaluation: 16 prompts, average 99/100; every prompt at least 85/100
...
The console renders the 16 tracked prompt blocks from `PROMPTS.md`; it no longer
