...
- Tauri 2 plus a shared React/TypeScript workbench is the accepted Windows and
  macOS target architecture. It remains DRAFT until package, signing, update,
  accessibility, and clean-host gates pass on both target operating systems.
